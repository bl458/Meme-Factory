...
export class Initial1601697185828 implements MigrationInterface {
    name = 'Initial1601697185828'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `image` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `size` int NOT NULL, `width` int NOT NULL, `height` int NOT NULL, `url` varchar(255) NOT NULL, `blurPlaceholder` longtext NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `userId` int NULL, `adminId` int NULL, UNIQUE INDEX `IDX_602959dc3010ff4b4805ee7f10` (`url`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
